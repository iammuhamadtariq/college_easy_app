...
class StudentTab1:
    def __init__(self, Page, user_id):
        ...
        cur.execute("SELECT * FROM studentTable WHERE user_id=" + str(shared_variable))
        ...
        profile_name = Label(self.page, text="Course :", bg="lightgreen", font=("arial",12,"bold"))
        ...
        profile_name = Label(self.page, text="Course Fee :", bg="lightgreen", font=("arial",12,"bold"))
